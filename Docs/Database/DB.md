# Database — AcmePay payment-api-nest
...
| id | uuid PK | |
| name | string | |
| api_key_hash | string unique | `sha256(raw_key)` hex |
| api_key_prefix | string(16) | Display / lookup hint |
...
Schema: `prisma/schema.prisma`. Migrations: `npx prisma migrate dev`. Seed: `npm run db:seed`.
